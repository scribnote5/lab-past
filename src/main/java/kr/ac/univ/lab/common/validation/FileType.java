...
public class FileType {
	...
	public static Set<String> invalidMimTypeSet = new HashSet<String>();
	...
	static {
		// Application
		invalidMimTypeSet.add("application/x-msdownload"); // .exe
		invalidMimTypeSet.add("application/x-msdownload; format=pe32"); // .exe
		invalidMimTypeSet.add("application/java-archive"); // .jar
		invalidMimTypeSet.add("application/javascript"); // .js
		invalidMimTypeSet.add("application/x-shockwave-flash"); // .swf
		invalidMimTypeSet.add("application/octet-stream"); // .bin 등의 실행 파일
		invalidMimTypeSet.add("application/x-msmetafile"); // .wmf
		invalidMimTypeSet.add("application/java-vm"); // .class
		invalidMimTypeSet.add("application/vnd.ms-htmlhelp"); // .chm
		invalidMimTypeSet.add("image/x-portable-graymap"); // .pgm
		invalidMimTypeSet.add("image/x-pcx"); // .pcx
		invalidMimTypeSet.add("application/winhlp"); // .hlp
		invalidMimTypeSet.add("application/vnd.americandynamics.acc"); // .acc
		invalidMimTypeSet.add("text/css"); // .css
		invalidMimTypeSet.add("application/x-sh"); //.sh
	}
