package kr.ac.univ.lab.common.error.handler;
...
import kr.ac.univ.lab.common.error.ErrorResponse;
import kr.ac.univ.lab.common.error.exception.AnonymousUserException;
import kr.ac.univ.lab.common.error.exception.BusinessException;
...
public class GlobalExceptionHandler {
    ...
    /**
     * javax.validation.Valid or @Validated으로 binding error 발생시 발생
    ...
    protected ResponseEntity<ErrorResponse> handleAnonymousUserException(final AnonymousUserException e) {
        log.error("handleAnonymousUserException", e);
        final ErrorResponse response = ErrorResponse.of(ErrorCode.ANONYMOUS_USER_ACCESS_DENIED); 
